...
<head>
    ...
    <title>Register - Pelangi Laundry</title>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" id="name" class="form-control"
                        placeholder="Masukkan nama lengkap" required autofocus value="{{ old('name') }}">
                </div>
                ...
                <div class="text-center">
                    <small>Sudah punya akun? <a href="{{ url('/login') }}">Login sekarang</a></small>
                </div>
            </form>
        </div>
    </div>
